...
from PyQt6.QtWidgets import (
    ...
    QFrame, QGraphicsDropShadowEffect, QGraphicsOpacityEffect, QGridLayout, QPushButton
)
...
class WeatherDisplay(QFrame):
    def __init__(self):
        ...
        clock_column.addWidget(self.digital_clock)

        top_row.addWidget(self.location)
        top_row.addStretch()
