...
class WeatherApp(QWidget):
    def __init__(self):
        ...
        CITY_LIST = sorted({c['name'] for c in cities.values()})
    ...
    def fetch_suggestions(self):
        ...
        self.thread = QThread()
        self.worker = SuggestWorker()
        self.worker.moveToThread(self.thread)

        self.thread.started.connect(lambda: self.worker.run(text))
        self.worker.finished.connect(self.apply_suggestions)
