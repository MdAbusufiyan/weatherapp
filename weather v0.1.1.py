...
from PyQt6.QtWidgets import (
    ...
    QFrame, QGraphicsDropShadowEffect, QGraphicsOpacityEffect, QGridLayout, QPushButton, QSizePolicy, QLineEdit
)
...
class WeatherApp(QWidget):
    ...
    def search_city(self):
        city = self.weather_display.search_input.text().strip()
        if not city:
            return
        ...
        try:
            ...
            res = requests.get(geo_url, headers={"User-Agent": "weather-app"}).json()
