...
class WeatherApp(QWidget):
    def __init__(self):
        ...
        self.weather_display.setFixedHeight(360)
        ...
        metrics_layout.addWidget(self.uv_bar)
        metrics_layout.addWidget(self.feels_bar)
        metrics_layout.addWidget(self.cloud_bar)
